...
const TOKEN = 'campanha-limpa-busca-20260831-x7k9'
const LOCAL_PHP = path.resolve(__dirname, 'limpar-igrejas-busca.php')
const REMOTE_NAME = '_tmp_limpar_igrejas.php'
